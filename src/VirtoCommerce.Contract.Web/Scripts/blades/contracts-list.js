angular.module('Contract')
    .controller('Contract.contractsListController',
        ['$scope', 'Contract.webApi', 'platformWebApp.bladeUtils', 'platformWebApp.dialogService', 'uiGridConstants', 'platformWebApp.ui-grid.extension', 'platformWebApp.uiGridHelper',
            function ($scope, contracts, bladeUtils, dialogService, uiGridConstants, gridOptionExtension, uiGridHelper) {
                ...
                function createContract() {
                    var newBlade = {
                        ...
                        template: 'Modules/$(VirtoCommerce.Contract)/Scripts/blades/contract-details.html'
                    };
                ...
                //Contract.blades.contracts-list.title
            }]);
